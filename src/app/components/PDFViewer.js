    ...
    <div className="text-center">
      <div className="mb-4 flex justify-end">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 dark:bg-green-800 dark:hover:bg-green-700 text-white rounded transition-colors"
        >
